...
const studentModel=require('../db/models/mastudentModel');
...
router.get('/mogetBatch',async (req,res)=>{
    try{
        const batchs=await mobatchModel.find();
        res.json(batchs);
    }catch(err){
        res.send({err:"server error"});
    }
...
router.get('/getMoStudents/:id',async (req,res)=>{
    try{
        ...
        const x=await mobatchModel.findById(bid);
        console.log(x);
        const data = await mobatchModel.aggregate([
            {
                $match: {
...
router.get('/getmoStudent/:id',async (req,res)=>{
    try{
        ...
        const student =await mostudentModel.aggregate([
            {
                $match: {
    ...
    try {
        ...
        res.json({
            ...
            q1: {
                ...
                total: data.q1.poor * 20 + data.q1.fair * 40 + data.q1.good * 60 + data.q1.vgood * 80 + data.q1.excellent * 100,
                avg: (data.q1.poor * 20 + data.q1.fair * 40 + data.q1.good * 60 + data.q1.vgood * 80 + data.q1.excellent * 100) / data.totalresponse
            },
            q2: {
                poorno: data.q2.poor,
                ...
                total: data.q2.poor * 20 + data.q2.fair * 40 + data.q2.good * 60 + data.q2.vgood * 80 + data.q2.excellent * 100,
                avg: (data.q2.poor * 20 + data.q2.fair * 40 + data.q2.good * 60 + data.q2.vgood * 80 + data.q2.excellent * 100) / data.totalresponse
            },
            q3: {
                poorno: data.q3.poor,
                ...
                total: data.q3.poor * 20 + data.q3.fair * 40 + data.q3.good * 60 + data.q3.vgood * 80 + data.q3.excellent * 100,
                avg: (data.q3.poor * 20 + data.q3.fair * 40 + data.q3.good * 60 + data.q3.vgood * 80 + data.q3.excellent * 100) / data.totalresponse
            },
            q4: {
                poorno: data.q4.poor,
                ...
                total: data.q4.poor * 20 + data.q4.fair * 40 + data.q4.good * 60 + data.q4.vgood * 80 + data.q4.excellent * 100,
                avg: (data.q4.poor * 20 + data.q4.fair * 40 + data.q4.good * 60 + data.q4.vgood * 80 + data.q4.excellent * 100) / data.totalresponse
            },
            q5: {
                poorno: data.q5.poor,
                ...
                total: data.q5.poor * 20 + data.q5.fair * 40 + data.q5.good * 60 + data.q5.vgood * 80 + data.q5.excellent * 100,
                avg: (data.q5.poor * 20 + data.q5.fair * 40 + data.q5.good * 60 + data.q5.vgood * 80 + data.q5.excellent * 100) / data.totalresponse
            },
            q6: {
                poorno: data.q6.poor,
                ...
                total: data.q6.poor * 20 + data.q6.fair * 40 + data.q6.good * 60 + data.q6.vgood * 80 + data.q6.excellent * 100,
                avg: (data.q6.poor * 20 + data.q6.fair * 40 + data.q6.good * 60 + data.q6.vgood * 80 + data.q6.excellent * 100) / data.totalresponse
            },
            q7: {
                poorno: data.q7.poor,
                ...
                total: data.q7.poor * 20 + data.q7.fair * 40 + data.q7.good * 60 + data.q7.vgood * 80 + data.q7.excellent * 100,
                avg: (data.q7.poor * 20 + data.q7.fair * 40 + data.q7.good * 60 + data.q7.vgood * 80 + data.q7.excellent * 100) / data.totalresponse
            },
            q8: {
                poorno: data.q8.poor,
                ...
                total: data.q8.poor * 20 + data.q8.fair * 40 + data.q8.good * 60 + data.q8.vgood * 80 + data.q8.excellent * 100,
                avg: (data.q8.poor * 20 + data.q8.fair * 40 + data.q8.good * 60 + data.q8.vgood * 80 + data.q8.excellent * 100) / data.totalresponse
            },
            q9: {
                poorno: data.q9.poor,
                ...
                total: data.q9.poor * 20 + data.q9.fair * 40 + data.q9.good * 60 + data.q9.vgood * 80 + data.q9.excellent * 100,
                avg: (data.q9.poor * 20 + data.q9.fair * 40 + data.q9.good * 60 + data.q9.vgood * 80 + data.q9.excellent * 100) / data.totalresponse
            },
            q10: {
                ...
                total: data.q10.poor * 20 + data.q10.fair * 40 + data.q10.good * 60 + data.q10.vgood * 80 + data.q10.excellent * 100,
                avg: (data.q10.poor * 20 + data.q10.fair * 40 + data.q10.good * 60 + data.q10.vgood * 80 + data.q10.excellent * 100) / data.totalresponse
            }
        });
    } catch (err) {
        console.error(err);
